            ...
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  ...
                  <Link href={`/${locale}/solutions`}>
                    <Button size="lg" variant="outline" className="px-8 py-6 text-base font-medium border-primary/20 hover:bg-primary/5">
                      {t('digital.cta.secondaryButton', { fallback: 'Explore All Solutions' })} <ArrowRight className="ml-2 h-4 w-4" />
                    </Button>
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-muted/30 p-8 md:p-12 flex flex-col justify-center">
                <h3 className="text-xl font-semibold mb-6">
                  {t('digital.cta.caseStudiesTitle', { fallback: 'Success Stories' })}
                </h3>
                
                <div className="space-y-4">
                  {caseStudies.map((study, index) => (
                    <Card key={index} className="bg-background border-border hover:border-primary/20 transition-colors">
                      <CardContent className="p-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {study.tags.map((tag, tagIndex) => (
                            <span key={tagIndex} className="text-xs bg-primary/10 text-primary px-2 py-0.5 rounded-full">
                              {tag}
                            </span>
                          ))}
                        </div>
